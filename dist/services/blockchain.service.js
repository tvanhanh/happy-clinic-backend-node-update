...
exports.uploadHashToBlockchain = uploadHashToBlockchain;
exports.getRecordFromBlockchain = getRecordFromBlockchain;
...
async function uploadHashToBlockchain(patientId, ipfsCID, pdfHash) {
...
async function getRecordFromBlockchain(patientId, index) {
    try {
