...
async function uploadToStorage(file) {
    ...
    const originalname = file.originalname || path_1.default.basename(filePath);
    ...
    if (!USE_S3) {
        ...
        const outDir = path_1.default.resolve(process.cwd(), "public", "uploads");
        if (!fs_1.default.existsSync(outDir))
            fs_1.default.mkdirSync(outDir, { recursive: true });
        const outPath = path_1.default.join(outDir, `${Date.now()}_${originalname}`);
